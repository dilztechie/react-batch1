          ...
          <div className="col-lg-7 offset-lg-2 g-0 mx-auto">
            <div className="fill-form form-box">
              <div className="row g-0">
                <div className="col-xl-6 col-lg-12 d-md-none d-sm-none 
                d-xs-none d-lg-block form-box_img">
                  <img alt="" src={genius} />
                </div>
                <div className="col-xl-6 col-lg-12 col-md-12 form-box_content">
                  <div id="box-title">
                    ...
                    <div className="d-grid mt-4">
                      <button className="btn btn-primary btn-lg" type="submit" value="Send">
                        <svg
                          ...
                          width="27" height="27" fill="currentColor" className="bi bi-mailbox2"
                          viewBox="0 0 16 16">
